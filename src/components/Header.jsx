                        ...
                        <li className="menu-item">
                          ...
                          <ul className="dropdown">
                            ...
                            <li>
                              ...
                              <ul className="dropdown">
                                <li>
                                  <a href="page-courses.html">Course Style1</a>
                                </li>
                                <li>
                                  <a href="page-courses2.html">Course Style2</a>
                                </li>
                                <li>
                            ...
                            <li>
                              <a href="#">
                                Job <span className="badge bg-danger">New</span>
                              </a>
                              <ul className="dropdown">
                                <li>
                                    ...
                                    <ul className="list-unstyled">
                                      ...
                                      <li>
                                        <a href="shortcode-button-groups-and-dropdowns.html">
                                          <i className="fa fa-link"></i> Buttons
                                          groups & Dropdowns
                                        </a>
                                      </li>
                                      <li>
                                    ...
                                    <ul className="list-unstyled">
                                      ...
                                      <li>
                                        <a href="shortcode-flickr-feed.html">
                                          <i className="fas fa-rss"></i> Flickr
                                          Feed
                                        </a>
                                      </li>
                                      <li>
                                    ...
                                    <ul className="list-unstyled">
                                      ...
                                      <li>
                                        <a href="shortcode-media-embed.html">
                                          <i className="fas fa-code"></i> Media
                                          Embed
                                        </a>
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                        <a href="shortcode-owl-carousel.html">
                                          <i className="fas fa-images"></i> Owl
                                          Carousel
                                        </a>
                                      </li>
                                      <li>
