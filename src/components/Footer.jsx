        ...
        <div className="container pt-90 pb-40">
            ...
            <div className="col-md-6 col-lg-6 col-xl-4">
                ...
                <ul className="mb-30">
                    ...
                    <div className="text"><a href="tel:+123-456-789">+123-456-789</a></div>
                    </li>
                    <li className="contact-email">
                    <div className="icon"><i className="flaticon-contact-043-email-1"></i></div>
                    <div className="text"><a href="mailto:contact@yourdomain.com">contact@yourdomain.com</a></div>
                    </li>
                    <li className="contact-website">
                    <div className="icon"><i className="flaticon-contact-035-website"></i></div>
                    <div className="text"><a  href="http://yourdomain.com">yourdomain.com</a></div>
                    </li>
                </ul>
                </div>
            </div>
            ...
            <div className="col-md-6 col-lg-6 col-xl-3">
                ...
                <div className="twitter-feed list-border clearfix" data-username="Envato" data-count="2"></div>
                </div>
            </div>
            <div className="col-md-6 col-lg-6 col-xl-3">
                <div className="widget">
            ...
            <div className="col-md-5 col-lg-5">
                ...
                <form id="mailchimp-subscription-form1" className="newsletter-form">
                <label htmlFor="mce-EMAIL"></label>
                    <div className="input-group">
                    <input type="email" id="mce-EMAIL" data-tm-height="45px" className="form-control" placeholder="Your Email"  name="EMAIL" value=""/>
                    <div className="input-group-append tm-sc-button">
                    <button type="submit" className="btn btn-theme-colored1 btn-sm" data-tm-height="45px">Subscribe</button>
                    </div>
                </div>
                </form>
