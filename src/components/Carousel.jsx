      ...
      <rs-module id="rev_slider_1_1" style="" data-version="6.3.3">
        <rs-slides>
          <rs-slide
            data-key="rs-2"
            data-title="Slide 1"
            data-thumb="https://via.placeholder.com/1920x800"
          ...
          >
            ...
            >
              <a href="page-about.html" className="btn btn-theme-colored4">
                Contact Us
              </a>
            </rs-layer>
            <rs-layer
          ...
          <rs-slide
            data-key="rs-11"
            data-title="Slide 1"
            data-thumb="https://via.placeholder.com/1920x1280"
            data-anim="ei:d;eo:d;s:d;r:default;t:slotslide-horizontal;sl:d;"
          >
            <img
              src="https://via.placeholder.com/1920x1280"
              title="Untitled-1"
              width="1920"
              height="1280"
              data-bg="p:center top;"
            ...
            <rs-layer
              ...
              className="font-current-theme1"
            >
              <a href="page-about.html" className="btn btn-theme-colored1">
                Contact Us
              </a>
            </rs-layer>
            <rs-layer
