            ...
            <p className="rs-p-wp-fix"></p>
             ...
             {/* <rs-module-wrap id="rev_slider_1_1_wrapper" data-alias="firoox-revolution-slider" data-source="gallery" style="background:transparent;padding:0;margin:0px auto;margin-top:0;margin-bottom:0;">
               <rs-module id="rev_slider_1_1" style="" data-version="6.3.3">
                <rs-slides>
                  <rs-slide data-key="rs-2" data-title="Slide 1" data-thumb="https://via.placeholder.com/1920x800" data-anim="ei:d;eo:d;s:d;r:default;t:slotslide-horizontal;sl:d;">
                    <img src="https://via.placeholder.com/1920x800" title="firoox-s1" width="1920" height="1280" data-bg="p:center top;" data-parallax="off" className="rev-slidebg" data-no-retina/>
                    <rs-layer
                      ...
                      style="z-index:12;"
                      className="font-current-theme2 bg-white text-theme-colored3 border-radius-5"
                    ...
                    ><a href="page-about.html" className="btn btn-theme-colored4">Contact Us</a>
                    </rs-layer>
                    <rs-layer
                  ...
                  <rs-slide data-key="rs-11" data-title="Slide 1" data-thumb="https://via.placeholder.com/1920x1280" data-anim="ei:d;eo:d;s:d;r:default;t:slotslide-horizontal;sl:d;">
                    <img src="https://via.placeholder.com/1920x1280" title="Untitled-1" width="1920" height="1280" data-bg="p:center top;" data-parallax="off" className="rev-slidebg" data-no-retina />
                    <rs-layer
                      ...
                      data-frame_999="o:0;st:w;sR:7500;"
                      style="z-index:12;"
                      className="font-current-theme2 bg-white text-theme-colored2 border-radius-5"
                    >Best Children Kindergarten
                    </rs-layer>
                    <rs-layer
                      ...
                      style="z-index:11;text-transform:capitalize;"
                      className="font-current-theme2"
                    >Kinder <span className="text-theme-colored1">Garten</span>
                    </rs-layer>
                    <rs-layer
                      ...
                      style="z-index:10;"
                      className="font-current-theme1"
                    ><a href="page-about.html" className="btn btn-theme-colored1">Contact Us</a>
                    </rs-layer>
                    <rs-layer
