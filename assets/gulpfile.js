...
gulp.task('default', function(){
	gulp.watch('source/scss/**/*.scss', ['sass-consilt', 'rtl-consilt', 'build-js', 'build-js-css']); 
})

//gulp.task('develop', gulp.series('sass-consilt', 'rtl-consilt'))


//Task 1 - scss to css
gulp.task('sass-consilt', function(){
	return gulp.src(
		[
		'source/scss/**/*.scss',
		]
...
gulp.task('rtl-consilt', function () {
